resource "aws_security_group" "api_subtubes_lb" {
  name        = "aapi-subtubes-loadbalancer"
  description = "aapi-subtubes-loadbalancer"
...
resource "aws_security_group_rule" "egress_all" {
  ...
  security_group_id = aws_security_group.api_subtubes_lb.id
}
